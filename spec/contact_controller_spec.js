  ...
  describe("search methods", () => {
    ...
    describe("#iterativeSearch()", () => {
        ...
        it("should return the contact if found", (done) => {
          this.book.addContact("Alloy Rodriguez", "111-111-111", "alloy@guerrilla-games.com")
          .then(() => {
            this.book.addContact("Magus Johnson", "101-010-101", "magus@squaresoft.com")
            .then(() => {
              this.book.getContacts()
              .then((contacts) => {
     ...
     describe("#binarySearch()", () => {
       ...
       it("should return null when contact is not found", (done) => {
         this.book.addContact("Zelda Smith", "000-100-111", "zelda@nintendo.com")
         .then(() => {
           this.book.getContacts()
           .then((contacts) => {
       ...
       it("should return the contact if found", (done) => {
         this.book.addContact("Alloy Rodriguez", "111-111-111", "allow@guerrilla-games.com").then(() => {
           this.book.addContact("Magus Johnson", "101-010-101", "magus@squaresoft.com").then(() => {
             this.book.addContact("Zelda Smith", "000-100-111", "zelda@nintendo.com").then(() => {
               this.book.addContact("Solid Snake", "100-100-100", "snake@konami.com").then(() => {
     ...
     describe("#search()", () => {
       ...
       it("should return the contact when found", (done) => {
         this.book.addContact("Solid Snake", "100-100-100", "snake@konami.com")
         .then(() => {
           this.book.search("Solid Snake")
           .then((contact) => {
